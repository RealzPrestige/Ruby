...
public class InputProvider {
	...
	/**
	 * Add a withListener to the provider. This withListener will be notified of
	 * commands detected from the input.
	 * 
	 * @param listener
	 *            The withListener to be added
	 */
	...
	/**
	 * Remove a withListener from this provider. The withListener will no longer be
	 * provided with notification of commands performe.
	 * 
	 * @param listener
	 *            The withListener to be removed
	 */
	...
	/**
	 * A simple withListener to respond to input and look up any required commands
	 * 
	 * @author kevin
	 */
