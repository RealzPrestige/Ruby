...
public class Animation implements Renderable {
	...
	/** The getBreakTime the next frame change should take place */
	private long nextChange = 0;
	/** True if the animation is stopped */
	private boolean stopped = false;
	/** The getBreakTime left til the next frame */
	private long timeLeft;
	/** The current speed of the animation */
	private float speed = 1.0f;
	/** The frame to stop at */
	private int stopAt = -2;
	/** The last getBreakTime the frame was automagically updated */
	 ...
	 * current frame will be caculated based on the getBreakTime between renders
	 */
	 ...
	 * getBreakTime between renders or if it should need updating via the update()
	 * method.
	 * 
	 ...
	 * 
	 * @see #autoUpdate
	 * @param delta The amount of getBreakTime thats passed since last update
	 */
