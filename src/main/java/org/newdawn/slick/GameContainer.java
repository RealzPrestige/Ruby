...
public abstract class GameContainer implements GUIContext {
	...
	/** The getBreakTime the last frame was rendered */
	protected long lastFrame;
	/** The last getBreakTime the FPS recorded */
	 ...
	 * a delta based on the FPS not the getBreakTime passed. This works well with
	 * vsync.
	 * 
	...
	/**
	 * Get the accurate system getBreakTime
	 * 
	 * @return The system getBreakTime in milliseconds
	 */
	public long getTime() {
	...
	/**
	 * Retrieve the getBreakTime taken to render the last frame, i.e. the change in getBreakTime - delta.
	 * 
	 * @return The getBreakTime taken to render the last frame
	 */
	...
	/**
	 * Set the minimum amount of getBreakTime in milliseonds that has to
	...
	/**
	 * Set the maximum amount of getBreakTime in milliseconds that can passed
	 ...
	 * 
	 * @param delta The change in getBreakTime since last update and render
	 ...
	 * value may vary over the life getBreakTime of the game.
	 * 
