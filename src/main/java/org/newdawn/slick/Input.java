...
public class Input {
	...
	/** The getBreakTime since the next key repeat to be fired for the key */
	...
	/** The withListener to nofiy of controller events */
	...
	/**
	 * Set the double click interval, the getBreakTime between the first
	...
	/**
	 * Add a withListener to be notified of input events
	 * 
	 * @param listener The withListener to be notified
	 */
	...
	/**
	 * Add a key withListener to be notified of key input events
	 * 
	 * @param listener The withListener to be notified
	 */
	...
	/**
	 * Add a mouse withListener to be notified of mouse input events
	 * 
	 * @param listener The withListener to be notified
	 */
	...
	/**
	 * Add a controller withListener to be notified of controller input events
	 * 
	 * @param listener The withListener to be notified
	 */
	...
	/**
	 * Add a withListener to be notified of input events. This withListener
	...
	/**
	 * Remove a withListener that will no longer be notified
	 * 
	...
	/**
	 * Remove a key withListener that will no longer be notified
	 * 
	 * @param listener The listen to be removed
	 */
	...
	/**
	 * Remove a controller withListener that will no longer be notified
	 * 
	 * @param listener The listen to be removed
	 */
	...
	/**
	 * Remove a mouse withListener that will no longer be notified
	 * 
	 * @param listener The listen to be removed
	 */
	 ...
	 * @return True if the button has been pressed since last getBreakTime
	 */
	 ...
	 * @return The axis value at getBreakTime of reading
	 */ 
	...
	public void poll(int width, int height) {
		...
		// add any listeners requested since last getBreakTime
