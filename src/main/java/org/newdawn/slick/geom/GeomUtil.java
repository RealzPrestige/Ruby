...
public class GeomUtil {
	...
	/** The withListener to notify of operations */
	...
	/**
	 * Set the withListener to be notified of geometry based operations
	 * 
	 * @param listener The withListener to be notified of geometry based operations
	 */
