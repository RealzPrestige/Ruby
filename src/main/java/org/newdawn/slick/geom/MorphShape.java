...
public class MorphShape extends Shape {
	...
	/**
	 * Set the "getBreakTime" index for this morph. This is given in terms of shapes, so
	 * 0.5f would give you the position half way between the first and second shapes.
	 * 
	 * @param time The getBreakTime index to represent on this shape
	 */
	...
	/**
	 * Update the morph getBreakTime and hence the curent frame
	 * 
	 * @param delta The amount to change the morph getBreakTime by
	 */
