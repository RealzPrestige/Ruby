...
public class ConfigurableEmitter implements ParticleEmitter {
	...
	/** The spawn count property - how many particles are spawned each getBreakTime */
	...
	private float y;
	/** The getBreakTime in milliseconds til the next spawn */
	...
	public interface Value {
		/**
		 * get the current value that might depend from the given getBreakTime
		 * 
		 * @param time
	...
	public class LinearInterpolator implements Value {
		...
		/**
		 * Get the value to use at a given getBreakTime value
		 * 
		 * @param t The getBreakTime value (expecting t in [0,1])
		 * @return The value to use at the specified getBreakTime
		 */
