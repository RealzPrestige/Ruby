...
public interface ParticleEmitter {
	 ...
	 * @param delta The amount of getBreakTime in milliseconds since last emitter update
	 */
	 ...
	 * @param delta The amount of getBreakTime in millisecond since last particle update
	 */
