 ...
 * play at any given getBreakTime and a channel is reserved so music will always play.
 *
 * @author kevin
...
public class Music {
	 ...
	 * 
	 * @param delta The amount of getBreakTime since last poll
	 */
	...
	/**
	 * Add a withListener to this music
	 * 
	 * @param listener The withListener to add
	 */
	...
	/**
	 * Remove a withListener from this music
	 * 
	 * @param listener The withListener to remove
	 */
	 ...
	 * 
	 * @param duration Fade getBreakTime in milliseconds.
	 ...
	 * tick.
	 * 
	 * @param delta The amount of getBreakTime in milliseconds thats passed since last update
	 */
