...
public class SVGMorph extends Diagram {
	...
	/**
	 * Update the morph getBreakTime index by the amount specified
	 * 
	...
	/**
	 * Set the "getBreakTime" index for this morph. This is given in terms of diagrams, so
	 * 0.5f would give you the position half way between the first and second diagrams.
	 * 
	 * @param time The getBreakTime index to represent on this diagrams
	 */
