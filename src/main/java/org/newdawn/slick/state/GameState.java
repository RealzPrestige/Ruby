...
public interface GameState extends InputListener {
	...
	/**
	 * Update the state's logic based on the amount of getBreakTime thats passed
	 * 
	 * @param container The container holding the game
	 * @param game The game holding this state
	 * @param delta The amount of getBreakTime thats passed in millisecond since last update
