...
public class ColorSwitchButton extends Button {
    ...
    public void render(int mouseX, int mouseY) {
        ...
        if (color.GetSwitch()) {
            RenderUtil.drawOutlineRect(x + width - 23, y + 2, x + width - 14, y + height - 2, ClickGui.Instance.color.GetColor(), 1.0f);
            RenderUtil.drawRect(x + width - 22, y + 3, x + width - 15, y + height - 3, color.GetColor().getRGB());
            RenderUtil.drawOutlineRect(x + width - 22, y + 3, x + width - 15, y + height - 3, ClickGui.Instance.color.GetColor(), 1.0f);
        }
        Ruby.fontManager.drawStringWithShadow(color.getName(), x, getStringMiddle(color.getName()), -1);
        if (opened) {
            glPushMatrix();
            ...
            Ruby.fontManager.drawStringWithShadow(color.getName(), panelX + (width / 2f) - (Ruby.fontManager.getStringWidth(color.getName()) / 2f), panelY - 7.5f - (Ruby.fontManager.getFontHeight() / 2f), -1);
            ...
            Ruby.fontManager.drawStringWithShadow(hex, panelX + 2, panelY + 103 - (Ruby.fontManager.getFontHeight() / 2f), -1);

            color.setColorValue(finalColor);
    ...
    protected boolean insideBox(int mouseX, int mouseY) {
        return mouseX > x + width - 28 && mouseX < x + width - 14 && mouseY > y + 2 && mouseY < y + height - 2;
    }
    ...
    public void click(int mouseX, int mouseY, int mouseButton) {
        if (mouseButton == 0 && insideSwitch(mouseX, mouseY)) {
            color.setSwitchValue(!color.GetSwitch());
        }
        if (color.GetSwitch()) {
    ...
    public void pasteClipBoard() {
        ...
        try {
            ...
            color.setColorValue(new Color(Integer.parseInt(color1[0]), Integer.parseInt(color1[1]), Integer.parseInt(color1[2]), Integer.parseInt(color1[3])));
