...
public class GuiInteger extends GuiSetting {
    IntegerSetting setting;
    int hoverAnimWidth;

    public GuiInteger(IntegerSetting setting) {
        super(setting);
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        Ruby.rubyFont.drawStringWithShadow(setting.getValue() + "", x + width - Ruby.rubyFont.getStringWidth(setting.getValue() + "") - 1, y + (height / 2f) - (Ruby.rubyFont.getHeight(setting.getName() + " " + setting.getValue()) / 2f), Color.GRAY.getRGB());
