...
public class ComboBoxButton extends Button {
    ...
    public void render(int mouseX, int mouseY) {
        ...
        Ruby.fontManager.drawStringWithShadow(name, x, middleHeight, -1);
        final String value = comboBox.GetCombo();
        Ruby.fontManager.drawStringWithShadow(value, x + Ruby.fontManager.getStringWidth(name + "  "), getStringMiddle(value), Color.GRAY.getRGB());
